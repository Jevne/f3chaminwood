...
import f3ChaminwoodTransparent from '../../public/f3-chaminwood-tranparent.webp';
import f3HeroImg from '../../public/F3ChaminwoodHero.webp';
import f3ShieldImg from '../../public/Chaminwood-shield.webp';
// #endregion
    ...
    <>
      ...
      <main>
        ...
        <section className={`bg-iron pt-20 px-4 pb-24`}>
          ...
          <Button href="/locations" text="FIND A WORKOUT" />
        </section>
